...
export const Route = createFileRoute("/features/$slug")({
  loader: ({ params }) => {
    const entry = findEntry("features", params.slug);
  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `/features/${loaderData.slug}` },
      ],
      links: [{ rel: "canonical", href: `/features/${loaderData.slug}` }],
      scripts: [
        {
...
function Page() {
  ...
  return <EntryPage section="features" entry={entry} />;
}
